...
class TestProjectStructure:
    ...
    def test_artifact_agent_package_exists(self):
        """Test that artifact_agent package exists."""
        root_dir = Path(__file__).parent.parent
    ...
    def test_readme_exists(self):
        """Test that README.md exists (optional but recommended)."""
        root_dir = Path(__file__).parent.parent
        readme = root_dir / "README.md"
        # README is optional for now, so we'll just check if it exists
        if readme.exists():
    ...
    def test_makefile_is_executable_conceptually(self):
        ...
        # On Unix-like systems, check if it's readable (executable check might fail in some environments)
    ...
    def test_pyproject_toml_format(self):
        ...
        assert "name = \"artifact_agent\"" in content, "pyproject.toml should define artifact_agent package"
