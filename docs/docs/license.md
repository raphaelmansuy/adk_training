...
id: license
title: "License"
description: "Apache 2.0 License for the ADK Training Hub project"
...
- Place warranty on the software (at your own risk)
...
This project uses various open source libraries and tools. Each has its own license:

- **Google ADK**: Apache 2.0 License
- **Docusaurus**: MIT License
- **React**: MIT License
- **TypeScript**: Apache 2.0 License
- **Python packages**: Various licenses (see individual package documentation)

Please review the individual licenses of any dependencies you use in your own projects.
...
**Note**: This is not legal advice. For legal questions, please consult with a qualified attorney.
