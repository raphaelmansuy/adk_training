---
id: tutorial/04_sequential_workflows
title: 'Tutorial 04: Sequential Workflows - Build Agent Pipelines'
description: Learn how to chain multiple agents in strict sequence to create sophisticated multi-step workflows
