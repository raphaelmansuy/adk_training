---
id: tutorial/05_parallel_processing
title: 'Tutorial 05: Parallel Processing - Speed Up with Concurrent Execution'
description: Learn how to execute multiple agents concurrently using ParallelAgent and the fan-out/gather pattern for faster workflows
sidebar_label: '05. Parallel Processing'
---

## Tutorial 05: Parallel Processing - Speed Up with Concurrent Execution
