---
id: 02_function_tools
title: Function Tools - Give Your Agent Superpowers
description: Learn how to create custom Python functions that your AI agents can call as tools
