---
id: 01_hello_world_agent
title: Hello World Agent - Your First ADK Agent
description: Build your first AI agent with Google Agent Development Kit from absolute zero
